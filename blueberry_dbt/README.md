...
**Answer**: `int_trips_unioned` only. In order to buld upstream and downstream dependencies a plus sign must be included before and after `int_trips_unioned`, respectively.
