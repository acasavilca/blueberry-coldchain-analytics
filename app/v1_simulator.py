...
def retrieve_satellite_data(
    ...
    measurements,
    timezone,
    is_historical=False, # Toggle between archive and forecast
    frequency="hourly",
):
    base_url = "https://archive-api.open-meteo.com/v1/archive" if is_historical else "https://open-meteo.com"
    ...
    df = df.rename(columns={
        ...
        "surface_pressure": "PS",
        "soil_temperature_28_to_100cm": "TSOIL_28_100CM",
    })
...
def prepare_forcing_arrays(df, resample_rate='1min'):
    ...
    forcing = {
        ...
        'TSOIL_28_100CM': df_resampled['TSOIL_28_100CM'].to_numpy(np.float64),
    }
...
def build_door_and_mass_schedules(
    ...
    for i in range(n):
        ...
        season_weight = monthly_weight[month_idx]
